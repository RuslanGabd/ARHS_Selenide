(() => {
    ...
    var __webpack_modules__ = {
        ...
        88069: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            const communicator_to_native_host_1 = __webpack_require__(89530), background_v1_1 = __webpack_require__(75664), background_v2_1 = __webpack_require__(34968), logger_1 = __webpack_require__(88901), set_browser_api_1 = __webpack_require__(92025), is_firefox_1 = __webpack_require__(84743), negotiationFailedError_1 = __webpack_require__(50063);
            ...
            communicator.on("LoadScriptsRequest", (request => {
                ...
                try {
                    return checkScriptVersion(loadRequest.backgroundVersion, 2, "Background"), checkScriptVersion(loadRequest.contentVersion, 1, "Content"), 
                    checkScriptVersion(loadRequest.apiVersion, 2, "API"), null == backgroundScript || backgroundScript.dispose(), 
                    ...
                    logger_1.Logger.groupEnd(), logger_1.Logger.disable();
                }
            ...
            })), (0, set_browser_api_1.setBrowserApi)(), chrome.runtime.onStartup.addListener((() => logger_1.Logger.log("Startup event"))), 
            (0, is_firefox_1.isFirefox)() && chrome.runtime.onInstalled.addListener((({reason}) => __awaiter(void 0, void 0, void 0, (function*() {
                switch (reason) {
                  case "install":
                    {
        ...
        28230: (__unused_webpack_module, exports) => {
            Object.defineProperty(exports, "__esModule", {
                value: !0
            ...
            exports.Frame = class {
                ...
                dispose() {
                    void 0 !== this.port && null !== this.port && (this.port.disconnectEvent && this.port.onDisconnect.removeListener(this.port.disconnectEvent), 
                    this.port = null);
                }
            };
        },
        ...
        75664: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            const urlSanitizer = __webpack_require__(17967), response_1 = __webpack_require__(74374), responseError_1 = __webpack_require__(99669), logger_1 = __webpack_require__(88901), window_removed_notification_1 = __webpack_require__(72012), window_focused_changed_notification_1 = __webpack_require__(26702), window_created_notification_1 = __webpack_require__(17408), is_firefox_1 = __webpack_require__(84743), unableToInjectScriptsError_1 = __webpack_require__(92480);
            class BackgroundV1 {
                ...
                injectScripts(tabId) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        try {
                            if ((0, is_firefox_1.isFirefox)()) return yield chrome.tabs.executeScript(tabId, {
        ...
        21887: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            const frame_1 = __webpack_require__(28230), response_1 = __webpack_require__(74374), responseError_1 = __webpack_require__(99669), logger_1 = __webpack_require__(88901), is_firefox_1 = __webpack_require__(84743), can_scripts_be_injected_1 = __webpack_require__(9805), extraction_result_1 = __webpack_require__(22206), unableToInjectScriptsError_1 = __webpack_require__(92480);
            class TabApi {
                constructor(tab, communicatorToNative, contentScriptVersionToLoad, apiScriptVersionToLoad, backgroundScript) {
                    var _a;
                    this.tab = tab, this.communicatorToNative = communicatorToNative, this.backgroundScript = backgroundScript, 
                    this.frames = null, this.id = null !== (_a = this.tab.id) && void 0 !== _a ? _a : 0, 
                ...
                dispose() {
                    this.lastForwardPort = void 0, this.lastMessage = void 0;
                    for (const [, frame] of Object.entries(this.frames)) frame.dispose();
                    this.frames = null;
                }
                execute(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        return yield this.ensurePortsAreSet(), logger_1.Logger.groupLoggingAsync((() => __awaiter(this, void 0, void 0, (function*() {
                            switch (request.name) {
                ...
                defaultHandler(request) {
                    var _a, _b, _c;
                    return __awaiter(this, void 0, void 0, (function*() {
                        if (null !== (_a = request.frameId) && void 0 !== _a || (request.frameId = 0), TabApi.isValidCssSelectorContentScriptRequest(request)) {
                            const cssSelectorRequest = request, cssSelector = cssSelectorRequest.parameters.cssSelectorPerFrame.pop(), frame = yield this.getFrameChildBySelectors(request.requestId, cssSelectorRequest.parameters.cssSelectorPerFrame);
                            if (!frame || frame.errorOccurred) throw new Error("Request does not belong to any port.");
                            request.frameId = frame.frameId, request.parameters.cssSelector = cssSelector, request.parameters.cssSelectorPerFrame = void 0;
                        }
                        return void 0 !== (null === (_b = this.frames[request.frameId]) || void 0 === _b ? void 0 : _b.port) && null !== (null === (_c = this.frames[request.frameId]) || void 0 === _c ? void 0 : _c.port) || (yield this.synchronizeFrames()), 
                ...
                testSelector(request) {
                    var _a, _b;
                    return __awaiter(this, void 0, void 0, (function*() {
                        let frame = this.frames[0], nodesFound = 0, result = null;
                        ...
                        for (let i = 0; i < selectorsPerFrame.length; i++) {
                            ...
                            request.parameters.cssSelectorPerFrame = void 0, request.frameId = null == frame ? void 0 : frame.frameId;
                            ...
                            response;
                            result = response, nodesFound += response.result.elementNodesMatched, frame = yield this.getFrameChildBySelector(request.requestId, selectorsPerFrame[i], frame);
                        }
                ...
                allFramesReturnTrue(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        for (const [, frame] of Object.entries(this.frames)) {
                            if (frame.errorOccurred || void 0 === frame.port || null === frame.port) continue;
                            request.frameId = null == frame ? void 0 : frame.frameId;
                            const response = yield this.defaultHandler(request);
                ...
                getAncestorList(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (const frameSelector of frameSelectors) {
                            ...
                            frame = yield this.getFrameChildBySelector(request.requestId, frameSelector, frame), 
                            request.frameId = null == frame ? void 0 : frame.frameId;
                        }
                ...
                getElementFromPoint(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (;;) {
                            ...
                            if (request.parameters.x -= offsetX, request.parameters.y -= offsetY, frame = yield this.getFrameChildBySelector(request.requestId, result.cssSelectorString, frame), 
                            null === frame) break;
                            request.frameId = null == frame ? void 0 : frame.frameId;
                        }
                ...
                getElementRectangle(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (const frameSelector of frameSelectors) {
                            ...
                            const response = yield this.defaultHandler(request);
                            if (null == response || response.error) break;
                            result = response.result, x += result.elementOffsetLeft, y += result.elementOffsetTop, 
                            frameSelectors.indexOf(frameSelector) !== frameSelectors.length - 1 && (x -= result.viewPortScrollLeft, 
                            y -= result.viewPortScrollTop), frame = yield this.getFrameChildBySelector(request.requestId, frameSelector, frame), 
                            request.frameId = null == frame ? void 0 : frame.frameId;
                        }
                ...
                getFocusedElement(request) {
                    ...
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        for (;;) {
                            ...
                            "iframe" !== (null === (_a = result.tag) || void 0 === _a ? void 0 : _a.toLowerCase()) && "frame" !== (null === (_b = result.tag) || void 0 === _b ? void 0 : _b.toLowerCase())) break;
                            if (frame = yield this.getFrameChildBySelector(request.requestId, result.cssSelectorString, frame), 
                            null === frame) break;
                            request.frameId = null == frame ? void 0 : frame.frameId;
                        }
                        return result.rectangleProperties.elementOffsetLeft = x, result.rectangleProperties.elementOffsetTop = y, 
                ...
                ensurePortsAreSet() {
                    return __awaiter(this, void 0, void 0, (function*() {
                        void 0 !== this.frames && null !== this.frames || (this.frames = {}, yield this.synchronizeFrames());
                    }));
                }
                synchronizeFrames() {
                    var _a;
                    return __awaiter(this, void 0, void 0, (function*() {
                        const frames = yield this.getAllFrames();
                        for (const $frame of frames) null == $frame || $frame.errorOccurred || (null === (_a = this.frames[$frame.frameId]) || void 0 === _a ? void 0 : _a.port) || ((0, 
                        can_scripts_be_injected_1.canScriptsBeInjected)($frame.url) && (yield this.injectScriptsToFrame($frame.frameId), 
                        this.setupConnection($frame)), this.frames[$frame.frameId] = $frame);
                        for (const [, frame] of Object.entries(this.frames)) frame.ordinal = yield this.getFrameOrdinal(frame.frameId);
                    }));
                }
                injectScriptsToFrame(frameId) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        try {
                            logger_1.Logger.log("Injecting scripts to frame: ", frameId, " at tab: ", this.id), 
                            (0, is_firefox_1.isFirefox)() ? (yield chrome.tabs.executeScript(this.id, {
                                file: this.contentScriptPath,
                                matchAboutBlank: !0,
                                frameId
                            }), yield chrome.tabs.executeScript(this.id, {
                                file: this.apiScriptPath,
                                matchAboutBlank: !0,
                                frameId
                            })) : yield chrome.scripting.executeScript({
                                target: {
                            ...
                            }), logger_1.Logger.log("Injected scripts to frame: ", frameId, " at tab: ", this.id);
                        } catch (e) {
                            throw new unableToInjectScriptsError_1.UnableToInjectScriptsError(e.message);
                        }
                    }));
                }
                setupConnection(frame) {
                    const customPort = chrome.tabs.connect(this.id, {
                        frameId: frame.frameId
                    });
                    null != customPort ? (customPort.windowId = this.tab.windowId, customPort.tabId = this.id, 
                    customPort.frameId = frame.frameId, customPort.disconnectEvent = disconnectedPort => {
                        this.lastForwardPort && this.lastMessage && (this.communicatorToNative.post(new response_1.Response(this.lastMessage, void 0, new responseError_1.ExceptionError(`Tab with id ${this.lastForwardPort.tabId} and frame ${this.lastForwardPort.frameId} is no longer available.`, 1))), 
                        this.lastForwardPort = void 0, this.lastMessage = void 0), this.frames && (this.frames[0].port === disconnectedPort ? (this.dispose(), 
                        this.backgroundScript.removeTab(this.id), logger_1.Logger.log("Port disconnected. Tab: ", this.id, "Frame: Root")) : this.frames[frame.frameId].port === disconnectedPort ? (this.frames[frame.frameId].dispose(), 
                        delete this.frames[frame.frameId], logger_1.Logger.log("Port disconnected. Tab: ", this.id, "Frame: ", frame.frameId)) : logger_1.Logger.warn("Disconnected tab port not found in the registry"));
                    }, customPort.onDisconnect.addListener(customPort.disconnectEvent), frame.port = customPort) : logger_1.Logger.warn(`Port to frame '${frame.frameId}' at tab '${this.id}' could not be created.`);
                }
                sendMessage(message) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        this.lastMessage = message;
                        const messagePort = this.lastForwardPort = this.frames[message.frameId].port;
                        return logger_1.Logger.log("Sending message to tab:", this.id, "and frame:", message.frameId, message), 
                        new Promise((resolve => {
                            const onMessage = m => {
                                logger_1.Logger.log("Received Message: ", m), m.requestId === message.requestId && (messagePort.onMessage.removeListener(onMessage), 
                                resolve(m));
                            };
                            messagePort.onMessage.addListener(onMessage), messagePort.postMessage(message);
                        }));
                    }));
                }
                getAllFrames() {
                    return new Promise(((resolve, rejected) => {
                        chrome.webNavigation.getAllFrames({
                            ...
                            if (null == tabs || tabs.length <= 0) return void rejected("No frames were returned.");
                            const result = [];
                            for (const tab of tabs) result.push(new frame_1.Frame({
                                errorOccurred: tab.errorOccurred,
                                frameId: tab.frameId,
                ...
                getFrameChildByOrdinal(ordinal, currentFrame) {
                    var _a;
                    return null === (_a = Object.entries(this.frames).find((([, f]) => !f.errorOccurred && f.parentFrameId === (null == currentFrame ? void 0 : currentFrame.frameId) && f.ordinal === ordinal))) || void 0 === _a ? void 0 : _a[1];
                }
                getFrameChildBySelector(requestId, selector, currentFrame) {
                    var _a;
                    return __awaiter(this, void 0, void 0, (function*() {
                        if (null != currentFrame || (currentFrame = this.frames[0]), null == currentFrame || currentFrame.errorOccurred) return null;
                        ...
                        let frame = this.getFrameChildByOrdinal(response.result, currentFrame);
                        return null == frame && (yield this.synchronizeFrames(), frame = this.getFrameChildByOrdinal(response.result, currentFrame)), 
                        null != frame ? frame : null;
                    }));
                }
                getFrameChildBySelectors(requestId, selectors) {
                    var _a;
                    return __awaiter(this, void 0, void 0, (function*() {
                        let currentFrame = null !== (_a = this.frames[0]) && void 0 !== _a ? _a : null;
                        if (null == currentFrame || currentFrame.errorOccurred) return null;
                        for (const selector of selectors) if (currentFrame = yield this.getFrameChildBySelector(requestId, selector, currentFrame), 
                        null == currentFrame) break;
                        return currentFrame;
                    }));
                }
                getFrameOrdinal(frameId) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        try {
                            if ((0, is_firefox_1.isFirefox)()) {
                                return (yield chrome.tabs.executeScript(this.id, {
                                    frameId,
                                    matchAboutBlank: !0,
                                    code: "var result = -1;\n                            if (window.parent !== window && window.parent !== null) {\n                                const frameWindows = window.parent.frames;\n                                for (var i = 0; i < frameWindows.length; i++) {\n                                    if (frameWindows[i] === window) {\n                                        result = i;\n                                    }\n                                }\n                            }\n                            result"
                                }))[0];
                            }
                            return (yield chrome.scripting.executeScript({
                                target: {
                                    tabId: this.id,
                                    frameIds: [ null != frameId ? frameId : 0 ]
                                },
                                func: () => {
                                    if (window.parent !== window && null !== window.parent) {
                                        const frameWindows = window.parent.frames;
                                        for (let i = 0; i < frameWindows.length; i++) if (frameWindows[i] === window) return i;
                                    }
                                    return -1;
                                }
                            }))[0].result;
            ...
            exports.TabApi = TabApi, TabApi.noframeErrorCode = 11;
        },
        34968: function(__unused_webpack_module, exports, __webpack_require__) {
            ...
            const urlSanitizer = __webpack_require__(17967), logger_1 = __webpack_require__(88901), window_removed_notification_1 = __webpack_require__(25746), window_focused_changed_notification_1 = __webpack_require__(93212), window_created_notification_1 = __webpack_require__(87466), is_firefox_1 = __webpack_require__(84743), tab_api_1 = __webpack_require__(21887), can_scripts_be_injected_1 = __webpack_require__(9805);
            class BackgroundV2 {
                constructor(communicatorToNative, contentScriptVersionToLoad, apiScriptVersionToLoad) {
                    this.communicatorToNative = communicatorToNative, this.contentScriptVersionToLoad = contentScriptVersionToLoad, 
                ...
                defaultHandler(request) {
                    return __awaiter(this, void 0, void 0, (function*() {
                        ...
                        if ($tab && (0, can_scripts_be_injected_1.canScriptsBeInjected)($tab.url)) return void 0 !== this.tabs[request.tabId] && null !== this.tabs[request.tabId] || (this.tabs[request.tabId] = new tab_api_1.TabApi($tab, this.communicatorToNative, this.contentScriptVersionToLoad, this.apiScriptVersionToLoad, this)), 
                ...
                registerHostEvents() {
                    ...
                    (0, is_firefox_1.isFirefox)() || this.communicatorToNative.on("RunJavaScriptRequest", (m => BackgroundV2.onRunJavaScript(m.parameters))), 
        ...
        84743: (__unused_webpack_module, exports) => {
            Object.defineProperty(exports, "__esModule", {
                value: !0
        ...
        92025: (__unused_webpack_module, exports, __webpack_require__) => {
            ...
            const is_firefox_1 = __webpack_require__(84743), logger_1 = __webpack_require__(88901);
